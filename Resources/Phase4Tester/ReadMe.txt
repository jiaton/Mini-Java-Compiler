...
1. Tar up your source code into "hw4.tgz"
  - All your files should be in a subdirectory named "hw4".
  ...
  - If you have comments for the grader, put it in a file called
    "hw4/ReadMe.txt".  That is the only non-Java file allowed.

2. Execute the "run" script (located in the same directory as this ReadMe
   file) and give it the path to your "hw4.tgz" file:

      # ./run SelfTestCases ../hw4.tgz
